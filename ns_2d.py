"""
This code base has been borrowed from the following github repository https://github.com/erik-norlin/Fourier-Neural-Operator.git
"""
...
#save .npy files
np.save('ns_2d_initialcond.npy', a.cpu().numpy())
np.save('ns_2d_solutions.npy', u.cpu().numpy())
np.save('ns_2d_time.npy', sol_t.cpu().numpy())
